...
#include "mem/cache/prefetch/learning_engine_base.h"
#include "mem/cache/prefetch/feature_knowledge.h"
...
public:
	LearningEngineFeaturewise(gem5::prefetch::Base *p, float alpha, float gamma, float epsilon, uint32_t actions, uint64_t seed, std::string policy, std::string type, bool zero_init);
