...
// #include "velma.h"
#include "mem/cache/prefetch/knobs.h"
#include "mem/cache/prefetch/util.h"
...
LearningEngineBasic::LearningEngineBasic(gem5::prefetch::Base *parent, float alpha, float gamma, float epsilon, uint32_t actions, uint32_t states, uint64_t seed, std::string policy, std::string type, bool zero_init, uint64_t early_exploration_window)
...
{
	gem5::prefetch::Pythia *scooby = (gem5::prefetch::Pythia*)m_parent;
